# Отчёт по курсовой задаче (вариант 23)
...
## Результаты работы
При запуске нескольких экземпляров вывод показывает последовательность звонков, занятость абонентов и завершение процессов. Наблюдатели программ 3 и 4 получают и отображают одинаковую информацию, что подтверждает корректность обмена событиями.
